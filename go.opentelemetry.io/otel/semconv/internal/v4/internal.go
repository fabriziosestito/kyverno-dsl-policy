...
type HTTPConv struct {NetConv interface{}; EnduserIDKey interface{}; HTTPClientIPKey interface{}; NetProtocolNameKey interface{}; NetProtocolVersionKey interface{}; HTTPMethodKey interface{}; HTTPRequestContentLengthKey interface{}; HTTPResponseContentLengthKey interface{}; HTTPRouteKey interface{}; HTTPSchemeHTTP interface{}; HTTPSchemeHTTPS interface{}; HTTPStatusCodeKey interface{}; HTTPTargetKey interface{}; HTTPURLKey interface{}; UserAgentOriginalKey interface{}}
